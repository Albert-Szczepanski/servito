...
export class UsersEffects {
  ...
  //   switchMap((users: UsersActions.GetUsersStart) => {
  //
  //     const options = {
  ...
  //     };
  //
  //     this.http.get<IUser[]>(`${environment.apiUrl}users`, options).
  //
  //     pipe(
  //       map(res => {
  //
  //         return new UsersActions.GetUsersSuccess(res)
  //       }), catchError(() => of(new UsersActions.GetUsersFailed('Action failed')))
  //     )
  //   })
  // ))
